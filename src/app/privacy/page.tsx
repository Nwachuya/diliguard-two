    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-white p-6 sm:p-12 font-sans">
      <div className="max-w-3xl w-full mx-auto space-y-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight uppercase">Privacy Policy</h1>
        ...
        <div className="prose prose-sm sm:prose lg:prose-lg max-w-none text-gray-700 leading-relaxed">
          ...
          <ul>
            ...
            <li>
              <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Diliguard.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to Diliguard, accessible from <a href="https://diliguardfront.canvass.africa" rel="external nofollow noopener" target="_blank">https://diliguardfront.canvass.africa</a>
            </li>
            <li>
